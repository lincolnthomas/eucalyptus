...
#
# clean-ceph-deleted.sh <CLC IP address>
#
...
echo $0 starting CephCleaner at:
date
java $JAVAPARAMS $EUCAJARS com.eucalyptus.blockstorage.CephCleaner $1
echo $0 finished CephCleaner at:
date
